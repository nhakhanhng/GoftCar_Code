...
C_DEPS += \
./STM32_RTOS_PeripheralDriver/UARTHandler/UART_Handler.d 


# Each subdirectory must supply rules for building sources it contributes
STM32_RTOS_PeripheralDriver/UARTHandler/%.o STM32_RTOS_PeripheralDriver/UARTHandler/%.su STM32_RTOS_PeripheralDriver/UARTHandler/%.cyclo: ../STM32_RTOS_PeripheralDriver/UARTHandler/%.c STM32_RTOS_PeripheralDriver/UARTHandler/subdir.mk
...
clean: clean-STM32_RTOS_PeripheralDriver-2f-UARTHandler

clean-STM32_RTOS_PeripheralDriver-2f-UARTHandler:
	-$(RM) ./STM32_RTOS_PeripheralDriver/UARTHandler/UART_Handler.cyclo ./STM32_RTOS_PeripheralDriver/UARTHandler/UART_Handler.d ./STM32_RTOS_PeripheralDriver/UARTHandler/UART_Handler.o ./STM32_RTOS_PeripheralDriver/UARTHandler/UART_Handler.su

.PHONY: clean-STM32_RTOS_PeripheralDriver-2f-UARTHandler
